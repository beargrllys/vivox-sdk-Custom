...
/* function prototypes */
int getopt(int argc, char * const argv[], const char *__optstring);
int getopt_long(int argc, char * const argv[], const char *__shortopts, const struct option *__longopts, int *__longind);
int getopt_long_only(int argc, char * const argv[], const char *__shortopts, const struct option *__longopts, int *__longind);
